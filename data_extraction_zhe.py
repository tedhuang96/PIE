...
# imdb = PIE(data_path=pie_path)
# # # imdb.extract_and_save_images(extract_frame_type='annotated')
# # imdb.extract_and_save_images_test()
...
# ped_data = data['set01']['video_0001']['ped_annotations'] # dict_keys(['1_1_1', '1_1_2', '1_1_3', '1_1_4', '1_1_5', '1_1_6', '1_1_7', '1_1_9', '1_1_13', '1_1_20', '1_1_21', '1_1_8', '1_1_14', '1_1_15', '1_1_18', '1_1_19', '1_1_16', '1_1_17', '1_1_10', '1_1_12', '1_1_11'])
pie_path = '.'
imdb = PIE(data_path=pie_path)
ped_data = data['set01']['video_0001']['ped_annotations']['1_1_1']
ped_frames = ped_data['frames']
ped_bboxes = ped_data['bbox']
print(len(ped_frames))
print(len(ped_bboxes))
